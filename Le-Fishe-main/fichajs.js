...
function calcular() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        let origemPericiasMap = {
            'Academico': ['ciências', 'investigação'],
            'AgenteDeSaúde': ['medicina','intuição'],
            'Artista': ['artes','enganação'],
            'Atleta': ['atletismo', 'fortitude'],
            'Criminoso': ['furtividade', 'crime'],
            


        };
    
        let origemSelect = document.getElementById('orig');
        ...
        origemSelect.addEventListener('change', function() {
            ...
            let selectedOrigem = origemSelect.value;
            let pericias = origemPericiasMap[selectedOrigem];
            
            if (pericias) {
                pericias.forEach(function(periciaId) {
                    document.getElementById(periciaId).checked = true;
                });
            }
        });
    });
